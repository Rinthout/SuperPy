...
def buy(args):
    if os.path.exists(bought_path):
        ...
        today = date.today()
        data = [next_id, args.product, today, args.price, args.expiration, args.quantity]
...
def buy_show(args):
    if os.path.exists(bought_path):
        ...
        console.print("File [yellow]bought.csv[/yellow] doesn't exists, please first [green]buy[/green] some products before you can see them!")
...
def sell(args):
    if os.path.exists(sold_path):
        ...
        if inventory < quantity:
            ...
            print("")
            console.print(f"[green]{product.upper()}[/green] in stock on [blue]{selling_date}[/blue]: [red]{inventory}[/red].")
...
def sell_show(args):
    if os.path.exists(sold_path):
        ...
        console.print("[red]ERROR[/red]")
        console.print("File [yellow]sold.csv[/yellow] doesn't exists, please first [green]buy[/green] some products before you can sell!")
        footnote()
